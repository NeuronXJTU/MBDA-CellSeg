...
parser.add_argument(
                    "--work_dir", default="work_dirs/bbda", \
...
def bbda(args):
    ...
    tr_ds = CustomDataset_CRC(labeled_file='breast_trainlab.txt',unlabeled_file='breast_trainunlab.txt',transform=train_transforms)
