...
from plmodule.BBDA import Pretrain,Distill,ThreeDistill,ThreeDistill_New_DisMethod
...
parser.add_argument(
                    "--work_dir", default="/media/oem/sda21/wxg/work_dirs/bbda", help="path where to save models and logs"
)
...
def bbda(args):
    ...
    net2 = monai.networks.nets.SwinUNETR(
            img_size=(args.input_size, args.input_size),
            in_channels=3,
            out_channels=args.num_class,
            feature_size=24,  # should be divisible by 12
    ...
    net3 = monai.networks.nets.SwinUNETR(
            img_size=(args.input_size, args.input_size),
            in_channels=3,
            out_channels=args.num_class,
            feature_size=24,  # should be divisible by 12
    ...
    tr_ds = CustomDataset_CRC(labeled_file='',transform=train_transforms)
